...
class Admin extends \nebula\we\App {
	...
	function createMenus(){
		...
		$sm->addItem('ProductCategory',$this->app->url(['index','page'=>'nebula\we\page\productcategories']));
		$sm->addItem('ProductAttachmentMap',$this->app->url(['index','page'=>'nebula\we\page\productattachmentmaps']));
		...
		$sm->addItem('ProductVariationAttachmentValueMap',$this->app->url(['index','page'=>'nebula\we\product\productvariationattachmentmaps']));

		$menu = $this->app->layout->menu->addMenu('Inventory');	
		$menu->addItem('Stock',$this->app->url(['index','product'=>'nebula\we\page\stocks']));
